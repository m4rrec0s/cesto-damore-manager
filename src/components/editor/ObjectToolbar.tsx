...
export const ObjectToolbar = ({
  ...
  }, [selectedObject?.id || selectedObject?.name || selectedObject?.type, updateNonce]);
          ...
          <>
            ...
            {type === "i-text" && (
              <>
                ...
                <select
                  className="bg-neutral-700 text-xs px-1 h-7 rounded max-w-[100px]"
                ...
                <div className="flex items-center bg-neutral-700/50 rounded p-0.5">
                  <Button
                    size="sm"
                    variant={selectedObject.fontWeight === "bold" ? "isSelected" : "ghost"}
                  ...
                  <Button
                    size="sm"
                    variant={selectedObject.fontStyle === "italic" ? "isSelected" : "ghost"}
                    className="dark h-7 w-7 p-0"
                ...
                <div className="flex items-center bg-neutral-700/50 rounded p-0.5">
                  <Button
                    size="sm"
                    variant={selectedObject.textAlign === "left" ? "isSelected" : "ghost"}
                    className="dark h-7 w-7 p-0"
                  ...
                  <Button
                    size="sm"
                    variant={selectedObject.textAlign === "center" ? "isSelected" : "ghost"}
                    className="dark h-7 w-7 p-0"
                  ...
                  <Button
                    size="sm"
                    variant={selectedObject.textAlign === "right" ? "isSelected" : "ghost"}
                    className="dark h-7 w-7 p-0"
